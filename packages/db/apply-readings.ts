/**
 * 一回限り: readings ロールの prompts (4 ジャンル軸) と model_assignment を本番に追加。
 * 既存行には触れず欠けている readings 行だけ create する (冪等)。
 *   DATABASE_URL=<target> pnpm --filter @a2p/db exec tsx apply-readings.ts
 */
