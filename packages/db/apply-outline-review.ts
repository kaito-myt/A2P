/**
 * 一回限り: outline_review ロールの prompts (4 ジャンル軸) と model_assignment を本番に追加。
 * 既存行には触れず欠けている行だけ create する (冪等)。
 *   DATABASE_URL=<target> pnpm --filter @a2p/db exec tsx apply-outline-review.ts
 */
import { PrismaClient } from './generated/index.js';
import { buildPromptSeeds, buildModelAssignmentSeeds } from './seed.js';

const ROLE = 'outline_review';
